...
class Phase0TestSuite {
    ...
    fun testRoomDatabaseCreation_Invariants() {
        ...
        assertEquals(20, AppDatabase.ALL_MIGRATIONS.size)
    }
    ...
    fun testMigrationInfrastructure_ExplicitRegistry() {
        ...
        assertEquals(20, migrations[19].startVersion)
